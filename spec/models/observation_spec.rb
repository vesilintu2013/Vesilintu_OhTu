...
describe Observation do
  ...
  describe "search method" do
    before do
      ...
      place_a = FactoryGirl.create(:place, :route_id => route_a.id)
      place_b = FactoryGirl.create(:place, :route_id => route_b.id, :observation_place_name => "TESTIPAIKKA")
      place_c = FactoryGirl.create(:place, :route_id => route_c.id, :observation_place_number => "10")
      place_d = FactoryGirl.create(:place, :route_id => route_d.id)
